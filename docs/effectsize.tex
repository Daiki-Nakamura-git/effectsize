...
\includegraphics{effectsize_files/figure-latex/unnamed-chunk-6-1.pdf}
...
既存のパッケージを利用した場合でも同様の結果が得られる。わずかに数値がずれるのは、\texttt{psychmeta}パッケージがガンマ関数を利用したより正確な補正係数の計算法を採用しているためである。
...
\includegraphics{effectsize_files/figure-latex/unnamed-chunk-47-1.pdf}
...
\includegraphics{effectsize_files/figure-latex/unnamed-chunk-50-1.pdf}
